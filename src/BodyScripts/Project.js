...
export default class Project extends Component {
  ...
  handleFilterClick = e => {
    ...
    if (
      this.state.filterObj !== elment.innerHTML &&
      this.state.filterType.includes(elment.innerHTML)
    ) {
    ...
    return (
      <>
        <div className="FilterBar" onClick={e => this.handleFilterClick(e)}>
          <span id="data1" className="ActiveFilter">
            All
          </span>
            ...
            Details={[
              {
                ...
                Source:
                  "https://github.com/TheRigidNinja/Tanky/tree/master/Tanky",
                IMG: Tanki,
